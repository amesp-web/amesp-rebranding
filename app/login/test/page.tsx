...
import { LogIn, Mail, Lock, ArrowLeft, Shield, Users } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/[0.08] to-accent/[0.12] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-2">🧪 Modo de Teste</h1>
          <p className="text-muted-foreground">Teste o sistema sem banco de dados</p>
        </div>
        ...
        <Card className="border-0 shadow-xl bg-gradient-to-br from-card via-card to-card/80 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <div>
                <CardTitle className="text-xl">Teste de Login</CardTitle>
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-muted-foreground">
            🧪 Esta é uma versão de teste para desenvolvimento
          </p>
        </div>
      </div>
    </div>
